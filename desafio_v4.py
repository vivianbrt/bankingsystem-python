#     APLICAÇÃO COM POO, GERADOR, ITERADOR E DECORADOR
# ATUALIZAÇÃO VERSÃO 04: Manipulação de arquivos, inclusão de LOG, 
import textwrap
...
# Método de representação do objeto em modo texto
